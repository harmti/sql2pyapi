...
from ..errors import TypeParsingError
...
def parse_create_type(
    sql_content: str,
    existing_composite_types: dict[str, list[ReturnColumn]] | None = None,
    existing_composite_type_imports: dict[str, set[str]] | None = None,
    ...
    for match in create_type_pattern.finditer(sql_content):
        ...
        try:
            ...
            fields, required_imports = parse_column_definitions(
                field_defs_str,
            ...
            if fields:
                ...
                logging.warning(
                    f"  -> No fields parsed for type {type_name} from definition: '{field_defs_str[:100]}...'"
                )
            else:
