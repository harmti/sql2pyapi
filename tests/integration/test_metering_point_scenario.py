...
"""
    ...
    get_metering_point = test_module['get_metering_point']
    ...
    async def test_functions():
        ...
        mock_cursor.fetchone.return_value = (
            ...
            (test_id, "MP-12345", datetime.now().date(), "123 Main St", "Anytown", 
             "12345", "US", "smart", "ACME", "SM-1000", "SN-123456", "1.2.3", 
             "2.0", 100.00, "kWh", "0.5", datetime.now().date(), datetime.now().date(),
             "John Doe", "john@example.com", "annual", datetime.now().date(), 
             datetime.now().date(), "active", datetime.now(), datetime.now()),
