...
def test_parse_sql_with_complex_file_content(tmp_path):
    ...
    assert f2.return_type == 'Optional[Any]' # Placeholder type before generation
    ...
    assert f3.return_type == 'List[Any]' # Placeholder type before generation
    ...
    assert f4.return_type == 'Optional[Any]' # Placeholder type before generation
    ...
    assert f4.return_columns[2] == ReturnColumn(name='quantity', sql_type='integer', python_type='int', is_optional=False)
    assert f4.return_columns[3] == ReturnColumn(name='price', sql_type='numeric(10, 2)', python_type='Optional[Decimal]', is_optional=True) # Explicit TABLE cols are optional by default
    ...
    assert f9.return_type == 'Optional[Any]' # Placeholder
    ...
    assert f10.return_type == 'List[Any]' # Placeholder
