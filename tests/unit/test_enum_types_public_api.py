...
def test_basic_enum_parsing():
    ...
    func_sql = create_test_function("get_users_by_status", "p_status status_type", "integer")
...
def test_schema_qualified_enum():
    ...
    func_sql = create_test_function("get_items_by_color", "p_color public.color_type", "integer")
...
def test_enum_array():
    ...
    func_sql = create_test_function("get_items_by_tags", "p_tags tag_type[]", "integer")
...
def test_enum_in_return_table():
    ...
    func_sql = create_test_function(
        "list_users_with_status", "", "TABLE(user_id integer, name text, status status_type)"
    )
...
def test_enum_in_table_schema():
    ...
    func_sql = create_test_function("get_user", "p_id integer", "users")
