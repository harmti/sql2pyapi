...
from tests.test_utils import TEST_DB_CONN_STRING  # Reverted back to absolute-like import
from tests.test_utils import setup_db_and_load_api  # Reverted back to absolute-like import
...
async def test_sql_default_non_null_value_used_when_python_arg_is_none(tmp_path):
    ...
    generate_python_code(functions, {}, {}, {})
    ...
    db_api = await setup_db_and_load_api(
        tmp_path, FUNC_SQL_DEFAULT_NON_NULL, sql_schema_content=None, module_name="test_default_value_api"
    )
